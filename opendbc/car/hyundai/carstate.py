...
class CarState(CarStateBase, EsccCarStateBase, MadsCarState, CarStateExt):
  ...
  def update_canfd(self, can_parsers) -> tuple[structs.CarState, structs.CarStateSP]:
    ...
    left_blinker_sig, right_blinker_sig = (("LEFT_LAMP_ALT", "RIGHT_LAMP_ALT") if cp.vl['BLINKERS']['USE_ALT_LAMP']
  ...
  def get_can_parsers_canfd(self, CP):
    msgs = []
    btn_msg = "CRUISE_BUTTONS_ALT" if CP.flags & HyundaiFlags.CANFD_ALT_BUTTONS else "CRUISE_BUTTONS"
